...
get_service_names() -> ['grpcbox.RouteGuide'].


get_service_def('grpcbox.RouteGuide') ->
    {{service, 'grpcbox.RouteGuide'},
...
get_rpc_names('grpcbox.RouteGuide') ->
    ['GetFeature', 'ListFeatures', 'RecordRoute',
     'RouteChat'];
get_rpc_names(_) -> error.


find_rpc_def('grpcbox.RouteGuide', RpcName) ->
    'find_rpc_def_grpcbox.RouteGuide'(RpcName);
find_rpc_def(_, _) -> error.


'find_rpc_def_grpcbox.RouteGuide'('GetFeature') ->
    #{name => 'GetFeature', input => point,
      output => feature, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_grpcbox.RouteGuide'('ListFeatures') ->
    #{name => 'ListFeatures', input => rectangle,
      output => feature, input_stream => false,
      output_stream => true, opts => []};
'find_rpc_def_grpcbox.RouteGuide'('RecordRoute') ->
    #{name => 'RecordRoute', input => point,
      output => route_summary, input_stream => true,
      output_stream => false, opts => []};
'find_rpc_def_grpcbox.RouteGuide'('RouteChat') ->
    #{name => 'RouteChat', input => route_note,
      output => route_note, input_stream => true,
      output_stream => true, opts => []};
'find_rpc_def_grpcbox.RouteGuide'(_) -> error.
